...
namespace TLExt {
    ...
    public:
        virtual ConfigToggle* addToggle(std::string label, SEL_MenuHandler onSelect);
        virtual ConfigButton* addButton(std::string label, SEL_MenuHandler onClick);
        virtual ConfigTextbox* addTextbox(std::string label, SEL_MenuHandler onConfirm);
        virtual ConfigRadio* addRadio(std::string label, std::vector<std::string> options, SEL_RadioHandler onSelect);
